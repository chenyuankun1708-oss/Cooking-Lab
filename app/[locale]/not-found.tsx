  ...
  return (
    <main id="main-content" className="min-h-screen bg-[var(--background)]">
      ...
      <section className="mx-auto max-w-4xl px-5 py-20 sm:py-28">
        <p className="text-sm font-semibold text-[var(--tomato)]">页面未找到 · Page not found</p>
        ...
        <div className="mt-8 flex flex-wrap gap-3">
          <Link href="/zh-CN" className="focus-ring inline-flex min-h-11 items-center rounded-[4px] bg-stone-950 px-5 font-semibold text-white">返回中文首页</Link>
          <Link href="/en" className="focus-ring inline-flex min-h-11 items-center rounded-[4px] border border-stone-400 px-5 font-semibold text-stone-800">English home</Link>
        </div>
      </section>
    </main>
  );
