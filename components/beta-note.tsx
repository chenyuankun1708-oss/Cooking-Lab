...
export function BetaNote({ title = "Public Beta 说明" }: { title?: string }) {
  return (
    <section
      ...
      className="border border-amber-200 bg-amber-50 px-4 py-4 text-sm text-stone-700 sm:px-5"
    >
      <p className="text-xs font-semibold tracking-[.16em] text-amber-900">PUBLIC BETA</p>
