    ...
    <main>
      <header className="bg-[#173f35] px-5 py-12 text-white">
        <div className="mx-auto max-w-7xl">
          <Link href="/" className="rounded text-sm font-semibold text-emerald-100 underline-offset-4 hover:underline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-white">← 返回料理决策首页</Link>
          ...
          <p className="mt-4 max-w-2xl leading-7 text-emerald-50/80">浏览完整的 30 道结构化菜谱。每道菜都包含清晰步骤、料理原理，以及基于 demo 数据的营养和成本估算。</p>
        </div>
      </header>
      <section className="mx-auto max-w-7xl px-4 py-10 sm:px-6" aria-labelledby="catalog-title">
        <div className="flex flex-wrap items-end justify-between gap-3">
          <div><p className="text-sm font-semibold text-emerald-700">完整目录</p><h2 id="catalog-title" className="mt-1 text-3xl font-bold">{catalog.length} 道菜谱</h2></div>
          <p className="text-sm text-stone-500">营养与价格均为 demo 估算</p>
        </div>
