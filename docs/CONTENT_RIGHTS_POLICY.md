...
AI 输出永远不能作为 Evidence，也不能修复输入权利缺陷。任何未来 AI artifact 必须记录 provider、model/version、生成日期、条款版本、prompt template、输入 artifact、输入权利复核、人工审核、相似性检查和商标检查。未经完整复核的生成内容不得发布。
