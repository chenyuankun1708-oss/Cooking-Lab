...
const pageCopy = {
  "zh-CN": {
    ...
    sections: [
      ...
      { title: "AI 不能成为证据", body: "AI 输出不能证明历史事实或修复输入权利缺陷。任何未来 AI 内容都必须记录模型与条款版本、输入权利、风险分级审查、相似性和商标检查。低风险内容可由独立 agent 审查，但不会被表示为真人审核、料理实测或法律意见。" },
    ],
  ...
  en: {
    ...
    sections: [
      ...
      { title: "AI is never Evidence", body: "AI output cannot prove historical facts or repair an input-rights defect. Any future AI artifact needs recorded model and terms versions, input-rights review, risk-based independent review, similarity review, and trademark review. Low-risk agent review is never represented as human review, culinary field testing, or legal opinion." },
    ],
