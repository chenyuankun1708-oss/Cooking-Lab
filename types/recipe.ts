...
export const recipePublicationStatuses = ["draft", "reviewed", "published"] as const;
export type RecipePublicationStatus = (typeof recipePublicationStatuses)[number];
export interface RecipePublication { status: RecipePublicationStatus }
